...
import { ArrowLeft, Plus, Target, User } from 'lucide-react';
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                { title: 'Tambah Sales User', href: '/admin/sales-management/create' },
            ]}
        >
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold">Tambah Sales User</h1>
                        <p className="text-muted-foreground">Buat akun sales user baru dengan target yang ditentukan</p>
                    </div>
                </div>
                        ...
                        <CardContent className="p-6">
                            <div className="flex flex-col justify-end gap-4 sm:flex-row">
                                ...
                                <Button type="submit" disabled={processing}>
                                    ...
                                    {processing ? 'Membuat...' : 'Buat Sales User'}
                                </Button>
                            </div>
                        </CardContent>
                    </Card>
